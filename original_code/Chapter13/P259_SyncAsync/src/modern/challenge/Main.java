...
public class Main {
    ...
    public static void main(String[] args)
        ...
        WaitAllResponsesDisplayBodies responses1 = new WaitAllResponsesDisplayBodies();
        responses1.waitAllResponses();

        logger.info("Wait all responses and fetch bodies in a List ...");
        WaitAllResponsesFetchBodiesInList responses2 = new WaitAllResponsesFetchBodiesInList();
        responses2.waitAllResponses();
    }
